...
```
 ...
 4\) Model outputs
 In your *outpath* directory, you will find all outputs for all integration strategies and modeling approaches. An output file structure is shown in Figure 2.
